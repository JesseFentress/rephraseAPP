"""
Django settings for rephraseAPP project.
...
SECRET_KEY = 'django-insecure-9@hjss3@!4e_ri)jwdbzyk&b$su$_ojsx-8)ne_!d%*vtf)8f&'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'app-rephrase.herokuapp.com', '127.0.0.1',
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'rephrase/static/media/images/')
